...
const Navbar = () => {
  ...
  <div class="navbar-start">
    <div class="dropdown">
      ...
      <ul tabindex="0" class="menu menu-compact dropdown-content mt-3 p-0 shadow bg-base-100 rounded-box w-52">
        {menuItems}
      </ul>
    </div>
    <Link to='/'><img src={logo} alt="" className='ml-16 h-6 w-40' /></Link>
  </div>
